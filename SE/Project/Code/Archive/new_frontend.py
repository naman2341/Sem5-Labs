...
def question_func():
    ...
    yes_btn = Button(bf, text='YES', font=cour15, fg='white',bg='black',command=balance_func)
...
def withdrawal_func():
    ...
    enter_btn = Button(bf, text='ENTER', font=cour15,fg='white',bg='black', command=question_func)
...
def change_pin_func():
    ...
    enter_btn = Button(bf, text='ENTER', font=cour15,fg='white',bg='black', command=message_func )
    enter_btn.pack(side=LEFT, pady=10)
...
def option_func():
   ...
   # option_win.grab_set()                       ## check enter_pin() function for the functionality of .grab_set()
    ...
    withdrawal_btn = Button(rf, text=' WITHDRAWAL ', font=cour15, fg='white',bg='black', command=withdrawal_func)
    withdrawal_btn.pack(padx=40, pady=10)

    balance_btn = Button(rf, text='BALANCE INQ', font=cour15,fg='white',bg='black', command=balance_func)
    ...
    exit_btn = Button(lf, text='   EXIT   ', font=cour15, fg='white',bg='black', command=lambda: [option_func.option_win.destroy(), enter_pin.new_win.deiconify()])
...
def enter_pin():
    ...
    enter_btn = Button(bf0, text='ENTER', font=cour15,fg='white',bg='black',command=acctype)
...
def acctype():
    ...
    bf0.pack()
    saving = Button(bf0,text='Savings', font=cour15,bg='black',fg='white',command=option_func,anchor='center')
    saving.pack(padx=30, pady=10,side=LEFT)
    current = Button(bf0,text="Current", font=cour15, bg='black',fg='white', command=option_func,anchor='center')
...
def takinginp():
   ...
   check = Functions.Card_no_verification(card_no)
   print(check)
   if check:
    error_msg = Label(win,text="Card available!", font=cour15, fg='red')
    error_msg.pack()
    error_msg.bind("<PIN>", enter_pin)
