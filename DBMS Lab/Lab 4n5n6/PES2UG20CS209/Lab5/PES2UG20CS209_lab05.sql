...
SELECT
train.Train_No,train.Train_Name,route_info.From_Station_No,route_info.From_Sta tion_name, route_info.To_Station_No,route_info.To_Station_Name,route_info.Distance
